class ModelViewer {
    ...
    activateSuperheroMode() {
        ...
        setTimeout(() => {
            ...
            this.superheroModelCache = { center, size, maxSize };
    ...
    updateSuperheroCamera() {
        ...
        const { center, size, maxSize } = this.superheroModelCache;
